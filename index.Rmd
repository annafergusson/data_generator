...
<button onclick='setupSpinner()' id='updateDRV'>Update</button>
</div>
...
$().ready(function(){
  ...
  // initialise tool
   ...
   var num_trials = 10;
    ...
    else
    {
        ...
        outcomes = myState.outcomes;
        probs = myState.probs;
        total_spins = myState.total_spins;
        num_trials = myState.num_trials;
    }
  ...
  //disable generate data button if drv is edited until update button is pressed
  $("td").keyup(function() {
...
function doStuff(dataframe){
    ...
    if(compareArrays(outcomes, prev_outcomes) && compareArrays(probs, prev_probs))
    {
      //no change
    }
    else
