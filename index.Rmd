...
<tr><td class='shadey'>Probability (%)</td><td contenteditable='true'>80</td><td contenteditable='true'>20</td></tr>
</table>
...
<div class='sectiony spinnery'>
Randomise <input type='number' id='spin_num' value=1> times <button onclick='makeSpin(1, 1)'>Check!</button>
</div>
...
//$("td").keyup(function(){setupSpinner()});
...
function setupSpinner(){
  ...
  {
    //show the sector
    var thisProp = table.rows[1].cells[i].innerHTML/100;
...
function nextSpin(this_spin, total_spins, starting_prop, this_trial, num_trials){
  ...
  for(var i = 1; i < table.rows[0].cells.length; i++)
  {
    ...
    probs.push(table.rows[1].cells[i].innerHTML/100);
  }
